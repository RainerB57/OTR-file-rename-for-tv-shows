...
class Ui_Form(object):
	def setupUi(self, Form):
		...
		self.commandLinkButton_4 = QtGui.QCommandLinkButton(self.tab_3)
		self.commandLinkButton_4.setObjectName(_fromUtf8("commandLinkButton_4"))
		self.gridLayout_4.addWidget(self.commandLinkButton_4, 1, 1, 1, 1)
		self.lineEdit_5 = QtGui.QLineEdit(self.tab_3)
		self.lineEdit_5.setObjectName(_fromUtf8("lineEdit_5"))
		self.gridLayout_4.addWidget(self.lineEdit_5, 1, 0, 1, 1)
		self.pushButton_3 = QtGui.QPushButton(self.tab_3)
		self.pushButton_3.setObjectName(_fromUtf8("pushButton_3"))
		self.gridLayout_4.addWidget(self.pushButton_3, 0, 1, 1, 1)
		self.commandLinkButton_5 = QtGui.QCommandLinkButton(self.tab_3)
		sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
		sizePolicy.setHorizontalStretch(0)
		sizePolicy.setVerticalStretch(0)
		...
		self.gridLayout_4.addWidget(self.commandLinkButton_5, 2, 1, 1, 1)
	...
	def retranslateUi(self, Form):
		...
		self.pushButton_3.setText(_translate("Form", "Load File", None))
		self.commandLinkButton_4.setText(_translate("Form", "Ursprünglicher Dateiname", None))
		self.commandLinkButton_5.setText(_translate("Form", "One File Rename", None))
		self.label_3.setText(_translate("Form", "Ursprünglicher Dateiname aus log.txt", None))
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "One File Rename Back", None))
